...
def aide_deux_modes():
    ...
    print"lors de chaque tour le joueur actif choisi 2 cartes dans les 4 cartes de la pioche revelee"
    print"le joueur non actif recoit les 2 cartes restantes"
    print"chaque joueur jette ensuite 2 cartes face cachee de son jeu"
...
def aide_choix_joueur():
    ...
    print"la carte sera remise dans la pioche par l'ordinateur puis melangees"
